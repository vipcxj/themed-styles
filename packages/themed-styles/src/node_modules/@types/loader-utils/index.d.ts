 ...
 */
export function getOptions<O extends OptionObject>(loaderContext: webpack.LoaderContext<O>): Readonly<O>;
 ...
 */
export function stringifyRequest<O extends OptionObject>(loaderContext: webpack.LoaderContext<O>, resource: string): string;

export function getRemainingRequest<O extends OptionObject>(loaderContext: webpack.LoaderContext<O>): string;

export function getCurrentRequest<O extends OptionObject>(loaderContext: webpack.LoaderContext<O>): string;
 ...
 */
export function interpolateName<O extends OptionObject>(loaderContext: webpack.LoaderContext<O>, name: string, options?: any): string;
